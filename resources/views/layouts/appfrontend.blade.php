                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html">
                                <img src="{{ asset('frontend') }}/assets/images/logo/logo2.png" alt="Site Logo" />
                            </a>
                        </div>
                    </div>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            <ul class="d-block">
                                                ...
                                                <li class="title"><a href="#">By Colors</a></li>
                                                <li><a href="shop-4-column.html"></a></li>
                                                <li><a href="shop-left-sidebar.html"></a></li>
                                            </ul>
                                            <ul class="d-block">
                                                <li class="title"><a href="#">By Range</a></li>
                                                <li><a href="single-product.html"></a></li>
                                                <li><a href="single-product-variable.html"></a></li>
                                            </ul>

                                            <ul class="d-block">
                                                <li class="title"><a href="#">By Brand</a></li>
        ...
        <div class="inner customScroll">
            ...
            <div class="offcanvas-menu mb-4">
                <ul>
                    ...
                    <li><a href="#"><span class="menu-text">Carpet</span></a>
                        <ul class="sub-menu">
                            <li>
                                <a href="#"><span class="menu-text">By Colrs</span></a>
                                <ul class="sub-menu">
                         
                                </ul>
                            </li>
                            <li>
                                <a href="#"><span class="menu-text">By Range</span></a>
                                <ul class="sub-menu">
                                   
                                </ul>
                            </li>
                            <li>
                                <a href="#"><span class="menu-text">By Brand</span></a>
                                <ul class="sub-menu">
                    ...
                    <div class="row">
                            ...
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="{{ route('frontend') }}">
                                        <img src="{{ asset('frontend') }}/assets/images/logo/logo2.png" alt="">
                                       <!-- <p class="footer-logo"><strong>FLOORMASTERS</strong> -->
                                </p>
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-subherading">
                                    <!-- News letter area -->
                                    <p class="address">Address Goes Here. <br>
                                       </p>
                                    <p class="phone"><a href="tel:0123456789"></a>Phone</p>
                                    <p class="mail">Email:<a href="mailto:demo@example.com"></a></p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copy-text"> © 2021 <strong>Floormasters</strong> 
                            <!-- <i class="fa fa-heart"
